...
import { MY_TICKETS_RESOLVED_BY_USER_SQL } from './caseExecutorSql.js';
...
/** Casos del usuario autenticado: solicitante, técnico asignado o quien cerró el caso */
export const MY_TICKETS_SCOPE_SQL = `
  (
    ${MY_TICKETS_USER_OWNERSHIP_SQL}
    OR ${MY_TICKETS_ASSIGNED_TECHNICIAN_SQL}
    OR ${MY_TICKETS_RESOLVED_BY_USER_SQL}
  )
`;
