-- Replica (plantilla GSS) — equivalente al paso 'Balance_Kelab_2026' del SQL Server Agent Job compartido
...
DELETE FROM [dbo].[Kel_Balance_2026]
INSERT INTO [dbo].[Kel_Balance_2026]
           ([Cuenta]
			,[Nombre_cuenta]
			,[NIT]
			,[Nombre_SN]
