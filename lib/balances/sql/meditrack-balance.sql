-- Replica (plantilla GSS) — equivalente al paso 'Balance_Meditrack_2026' del SQL Server Agent Job compartido
...
DELETE FROM [dbo].[Med_Balance_2026]
INSERT INTO [dbo].[Med_Balance_2026]
           ([Cuenta]
			,[Nombre_cuenta]
			,[NIT]
			,[Nombre_SN]
