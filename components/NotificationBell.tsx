  ...
  return (
    ...
    >
      ...
      <Popover.Dropdown p={0} className='notification-bell-dropdown'>
        <div className='notification-bell-header border-b border-[var(--app-border)]'>
            ...
            {view === 'unread' && unreadCount > 0 && (
              <UnstyledButton onClick={markAllRead}>
                <Group gap={4}>
                  ...
                  <Text size='xs' className='notification-bell-accent' fw={600}>
                    Marcar todas
                  </Text>
                </Group>
              </UnstyledButton>
        ...
        {isSupported && isAvailable && (
          ...
          >
            <Text size='xs' className='notification-bell-text' fw={500}>
              Notificaciones push
            </Text>
            <Switch
              size='sm'
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <Group gap={6} wrap='nowrap' mb={2}>
              ...
              <Text
                ...
                lineClamp={1}
                style={{ flex: 1 }}
                className='notification-bell-text'
              >
                {n.title}
              </Text>
            </Group>
