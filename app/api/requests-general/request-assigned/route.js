...
export async function GET(req) {
  try {
    ...
    let query = `
      SELECT
        rg.id, cr.category as category, up.name as [user], rg.[description], rg.id_company, c.company ,rg.created_at, u.name as 'requester', sc.status as [status], rg.subject_request as [subject], pc.process, pc.id as id_process_category, rg.resolution, rg.date_resolution, rg.status_req as id_status_case
